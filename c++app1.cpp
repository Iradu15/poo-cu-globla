...
public:
    ...
    friend void giving_birth(int, int);
    void update();
    bool isAlive();
...
void giving_birth(int x, int y) {
    ...
    double a = double(nrSons) * constGivingBirth;
    double b = floor(mat[i][j].energie / constGivingBirth);
    int MaxNumberOfSonsBeforeDeath = int(min(a, b));                        //daca da nastere la prea multi risca sa ramana fara energie
